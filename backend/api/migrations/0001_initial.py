# Generated by Django 5.0.7 on 2024-07-25 05:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personne', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.personne')),
            ],
        ),
        migrations.CreateModel(
            name='DossierMedical',
            fields=[
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.patient')),
                ('medecin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dossiers_medical', to='api.personnel')),
            ],
        ),
        migrations.CreateModel(
            name='Prescription',
